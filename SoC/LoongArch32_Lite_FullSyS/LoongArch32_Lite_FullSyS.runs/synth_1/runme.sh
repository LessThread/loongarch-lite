...
HD_PWD='D:/Work/vivado_project/LoongArch32_Lite_FullSyS/LoongArch32_Lite_FullSyS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LoongArch32_Lite_FullSyS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LoongArch32_Lite_FullSyS.tcl
