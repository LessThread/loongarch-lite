...
HD_PWD='D:/Work/vivado_project/LoongArch32_Lite_FullSyS/LoongArch32_Lite_FullSyS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LoongArch32_Lite_FullSyS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LoongArch32_Lite_FullSyS.tcl -notrace
